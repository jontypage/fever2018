...
args = {
    ...
    'task_name': 'mnli',
    'output_dir': '/home/miproj/4thyr.oct2019/jp730/fever2018/finetuning-roberta/roberta-fever-finetuned/',
    'do_train': False,
    'do_eval': True,
    'fp16': False,
    'fp16_opt_level': 'O1',
    ...
    'eval_size_during_training': 1.0,
    'save_steps': 20000,
    'eval_all_checkpoints': True,

    'overwrite_output_dir': False,
    'reprocess_input_data': False,
    'notes': 'Finetuning RoBERTa with Balanced FEVER Five'
}
...
model = model_class.from_pretrained(args['model_name'], num_labels=3, finetuning_task=args['task_name'])
...
def evaluate(model, tokenizer, prefix="", evaluate=False):
    ...
    if evaluate:
        eval_size = round(len(eval_dataset)*args['eval_size_during_training'])
        eval_sampler = RandomSampler(eval_dataset, replacement=True, num_samples=eval_size)
    else:
